...
<head>
	...
	<title>Ses Password Manager</title>
...
<div style="">
	...
	<center>
		<div class="content2">
	     ...
	     <thead>
	       <tr>
	         <th colspan="2">Допълнителна информация<a href="editAccount.php" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i> Редактирай </a></th>
	       </tr>
	     <thead>
		 <?php 
	     ...
	     <td style='text-transform: capitalize;'><?= $row['user_type'] ?></td>
	   </tr>
	     <tr>
